...
class HeatmapHead_VMamba(BaseHead):
    ...
    def forward(self, feats: Tuple[Tensor]) -> Tensor:
        ...
        # x = F.interpolate(x, size=(56, 56), mode='bilinear', align_corners=True)
        # print("x:", x.shape)
    ...
    def loss(self,
        ...
        # calculate losses
        losses = dict()
        # print("heatmap :", gt_heatmaps.shape)
        # print("pred_fields :", pred_fields.shape)
